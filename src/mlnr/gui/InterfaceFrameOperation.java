...
public interface InterfaceFrameOperation {
    ...
    /** This is called to notify that a different document has assumed focus. 
     * @param focusDocument is the DesignDocument to be focused now, can be null 
     *  indicating no DesignDocument is focused (no DesignDocuments in the program).
     */
    abstract public void notifyDocumentFocus(DesignDocument focusDocument);
